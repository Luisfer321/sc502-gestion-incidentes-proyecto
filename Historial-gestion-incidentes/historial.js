document.addEventListener("DOMContentLoaded", function () {
  ...
  // Cargar tabla de historial real desde archivo JSON
  fetch("backend/historial_incidente.php")
    ...
    .then((data) => {
      ...
      if (data.length === 0) {
        tabla.innerHTML = `<tr><td colspan="6" class="text-center">No hay historial registrado</td></tr>`;
        return;
      }
    ...
    .catch((error) => console.error("Error al cargar historial real:", error));
});